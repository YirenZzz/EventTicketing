...
// import { Search, HelpCircle, ChevronRight, Mail, PhoneCall, MessageSquare, FileText } from 'lucide-react';
...
//                   </div>
//                   <ChevronRight className={`h-5 w-5 text-gray-400 transform transition-transform duration-200 ${expandedFaq === index ? 'rotate-90' : ''}`} />
//                 </div>
//                 {expandedFaq === index && (
...
//               </div>
//               <button className="mt-4 flex items-center space-x-2 bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition-colors">
...
//           <p className="text-gray-600 mb-4">Our support team is here to help you with any questions you might have about our platform.</p>
...
//             </button>
//             <button className="flex items-center space-x-2 border border-purple-600 text-purple-600 px-4 py-2 rounded-md hover:bg-purple-50 transition-colors">
//               <MessageSquare className="h-5 w-5" />
//               <span>Live Chat</span>
//             </button>
//           </div>
    ...
    <div className="flex-1 overflow-auto">
      <header className="bg-white p-4 shadow-sm">
        <div className="max-w-5xl mx-auto">
          <Link href={`/dashboard/attendee/${userId}`} className="inline-flex items-center text-purple-600 hover:text-purple-800 transition-colors mb-4">
